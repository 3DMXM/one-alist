declare global {
  const StorageUtils: typeof import('../../server/utils/StorageUtils').StorageUtils
  const TokenUtils: typeof import('../../server/utils/TokenUtils').TokenUtils
...
declare global {
  // @ts-ignore
  export type { StorageUtils } from '../../server/utils/StorageUtils'
  import('../../server/utils/StorageUtils')
  // @ts-ignore
  export type { TokenUtils } from '../../server/utils/TokenUtils'
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'E:/web/aoe.top/one-alist/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'E:/web/aoe.top/one-alist/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { StorageUtils } from 'E:/web/aoe.top/one-alist/server/utils/StorageUtils';
export { TokenUtils } from 'E:/web/aoe.top/one-alist/server/utils/TokenUtils';