...
declare module '@nuxt/schema' {
  interface ModuleDependencies {
    ["shadcn"]?: ModuleDependencyMeta<typeof import("shadcn-nuxt").default extends NuxtModule<infer O> ? O : Record<string, unknown>>
  ...
  interface NuxtConfig {
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["shadcn-nuxt", Exclude<NuxtConfig["shadcn"], boolean>] | ["@pinia/nuxt", Exclude<NuxtConfig["pinia"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
}
declare module 'nuxt/schema' {
  interface ModuleDependencies {
